			...
			<div className='adop-card-info'>
				...
				<a href={`mailto: ${u_email}`} className='s-contact'>{u_email}</a><br />
				{
					(data.type === "Shelter")
						?
						<>
							<button className='adop-delete-btn' value={r_id} onClick={AcceptRequest} >Accept</button><br />
						...
						(data.type === "Admin")
							?
							<>
								<button className='adop-delete-btn' value={r_id} onClick={DeleteRequest}>Delete</button><br />
							</>
							:
							<></>
